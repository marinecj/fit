	...
	<div>
		<table>
			<tr>
				...
				<td><input type="text" name="CST_MID" id="CST_MID" value="fithawaii" readonly="true"/></td>
			</tr>
			<tr>
				<td>서비스,테스트 </td>
				<td><input type="text" name="CST_PLATFORM" id="CST_PLATFORM" value="test" readonly="true"/></td>
			</tr>
			<tr>
				<td>구매자 이름 </td>
			...
			<tr>
				<td>상품정보 </td>
				<td><input type="text" name="LGD_PRODUCTINFO" id="LGD_PRODUCTINFO" value="${hotelAllInfo.hotelInfo.hotelNmKr}" readonly="true"/></td>
			</tr>
			<tr>
				<td>결제금액 </td>

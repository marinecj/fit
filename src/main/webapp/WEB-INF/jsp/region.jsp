...
<div class="search-visual">
	<div class="sv-slides">
		<ul>
			<li style="background-image: url('${Img}/temp/search_visual.jpg')">
				<div class="txt-info">
					<p class="tx1">힐튼 하와이안 빌리지</p>
					<p class="tx2">Hilton Hawaiian Village Waikiki Beach Resort</p>
					<p class="tx3"><strong>397,000</strong>부터</p>
					<span class="discount"><strong>30</strong>%<em>추가 할인</em></span>
				</div>
			</li>
			<li style="background-image: url('${Img}/temp/search_visual.jpg')">
				<div class="txt-info">
...
<div id="container" class="goods-list-wrap">
	<div id="contents">
		...
		<div class="tit-box">
			<h2>${regionName}호텔</h2>
			<h3>핏하와이가 추천하는 ${regionName} 호텔</h3>
			<div class="sort">
